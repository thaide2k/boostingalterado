...
Config['Utils'] = {
    ["Rewards"] = {
        ...
        ["RewardItemName"] = "money", -- this will be the reward item name (no need to config if you are using an money as a reward)
        ["RewardMoneyAmount"] = "10000", -- this will be the amount the player recieves when he finish the mission (no need to config if you are using an item as a reward)
    ...
    ["Contracts"] = {
        ...
        ["ContractChance"] = 100, -- This is the luck percentage of getting a contract
    },
    ["VIN"] = {
        ...
        ["ForceVin"] = false, -- this will force vin contract optiion on any created contract turn to false to use days instead
        ["VinDays"] = 1, -- amount of days between vin contracts , (irl days) 
    },
    ["ClassPrices"] = {
        ['X'] = "35",
        ['A'] = "30",
    ...
    ["Laptop"] = {
        ...
        ["CopNotifyLength"] = 50000, -- Time in (ms) of the police Notify length
    },
}
